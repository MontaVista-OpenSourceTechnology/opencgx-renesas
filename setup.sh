...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-linaro.git;branch=thud;layer=meta-optee \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-renesas.git;branch=thud-dev;layer=meta-rcar-gen3 \
MACHINE@h3ulcb \
DISTRO@mvista-cgx \
