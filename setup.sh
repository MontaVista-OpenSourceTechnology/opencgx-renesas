...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-linaro.git;branch=dunfell;layer=meta-optee \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-renesas.git;branch=dunfell;layer=meta-rcar-gen3 \
MACHINE@h3ulcb \
DISTRO@mvista-cgx \
CONFIG@OPTEEMACHINE=rcar \
